...
def f_2():
    scatterplot(data=penguins, x='flipper_length_mm',
                y='body_mass_g', hue='sex', size='island', style='island')
    show()
...
# ● Использовать PairGrid с типом графика на ваш выбор
def f_3():
    x_vars = ['body_mass_g', 'bill_length_mm',
...
def f_4():
    data = penguins.pivot_table(
        index='species', columns='island', values='body_mass_g')
    heatmap(data)
